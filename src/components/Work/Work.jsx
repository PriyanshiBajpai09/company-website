...
const workData = [
  {
    ...
    image: "https://images.unsplash.com/photo-1648134859196-3aa762e9440d?w=800&q=80",
  ...
  },
  {
    ...
    image: "https://i.pinimg.com/1200x/79/2e/9c/792e9c43e79d33c94ab4495a56433431.jpg",
    tags: ["React", "Tailwind"],
    github: "#",
    webapp: "#",
  },
  ...
  },
  {
    ...
    description:
      "Real-time chat app using sockets with modern UI.",
  ...
  },
  {
    ...
    title: "Landing Page",
    description:
      "Creative landing page with animations and optimized UI.",
    image: "https://cdn.dribbble.com/userupload/43553703/file/original-c4979197d7c5be33c6f041ffd59fc129.png?w=800",
    tags: ["HTML", "CSS"],
    github: "#",
    webapp: "#",
  },
  {
    ...
    image: "https://cdn.dribbble.com/userupload/46829657/file/048876181d6f5670b3097e49ff0c67b9.png?w=800",
    tags: ["React", "API"],
    github: "#",
    webapp: "#",
  },
    ...
    >
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          <div className="bg-[#0f172a] rounded-xl max-w-3xl w-full p-6 relative shadow-2xl">

            {/* Close */}
            <button
              onClick={() => setSelected(null)}
              className="absolute top-3 right-4 text-2xl text-white hover:text-purple-400"
            >
              ✕
            </button>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-1/2 bg-gray-700 hover:bg-purple-700 text-white py-2 rounded-lg text-center"
              >
                View Code
              </a>
              <a
                href={selected.webapp}
                className="w-1/2 bg-purple-600 hover:bg-purple-800 text-white py-2 rounded-lg text-center"
              >
                View Live
              </a>
            </div>
